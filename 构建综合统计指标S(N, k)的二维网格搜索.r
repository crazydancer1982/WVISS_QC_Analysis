...
#DATA_VECTOR=DATA_VECTOR[1:(length(DATA_VECTOR)/2)] #只用前5年的数据
#DATA_VECTOR=DATA_VECTOR[(length(DATA_VECTOR)/2):length(DATA_VECTOR)] #只用前5年的数据
...
quartz("heatmap of solutions for D S-score")
